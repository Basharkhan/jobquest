...
import com.khan.job_quest.common.response.ApiErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleUserExists(ResourceAlreadyExistsException ex, HttpServletRequest request) {
